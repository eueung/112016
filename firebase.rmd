$$$ cover-05-gen %split 40 %maxh 550 %opc 7 %pretitle Introduction - Realtime Database % titleprop .fsize175[.yellow[Firebase]] % authorprop [Eueung Mulyana](https://github.com/eueung) % linkprop https://eueung.github.io/112016/firebase % otherprop CodeLabs | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) %logopic images/firebase.png % bkgimg bkgs/rambutan.jpg 
---
$$$ slide-one % col t1 % title .fonth3[.yellow[**Firebase**] Version: **3.6.4**]<br/>.fonth4[.yellow[**Vue.JS**] **2.1.6** | .yellow[**VueFire**] **1.3.0** | .yellow[**Vue Material**] **0.5.2** ]
---
$$$ outline % fsize fonth4 %e1 |Introduction| %e2 |Quick Start| %e3 |VueFire| 
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Introduction] % bkgimg bkgs/rambutan.jpg % logopic images/firebase.png
---
...
$$$ part-2 % color2 t2 % align2 center %title2 # Firebase Realtime Database
.figplaint[
![](images/firebase.png)
]
$$$ part-3 
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Quick Start] % bkgimg bkgs/rambutan.jpg % logopic images/firebase.png
---
$$$ part-1 %split 40 %color1 t1 %align1 right %title1 # Firebase Setup
.fonth5[
...
---
$$$ part-1 %split 40 %color1 t1 %align1 right %title1 #Running Quickstart Sample
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # index.html
.fonth5[]
<br/>
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # main.css
.fonth5[]
<br/>
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # main.js
.fonth5[]
<br/>
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # JSON Export
.fonth5[]
<br/>
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[VueFire] % bkgimg bkgs/rambutan.jpg % logopic images/firebase.png %authorprop Firebase bindings for Vue.js
---
class: bkgpos_00 nopadding
...
$$$ part-2 % color2 t1 % align2 defaultalign %title2 # Code
.fonth5[]
<br/>
...
---
$$$ cover-05-section-gen %split 30 %maxh 550 %opc 7 % titleprop .fsize95[Refs] % bkgimg bkgs/rambutan.jpg % logopic images/firebase.png
---
# Refs
...
---
$$$ cover-05-gen %split 40 %maxh 550 %opc 7 %titleprop .fsize95[END] % authorprop [Eueung Mulyana](https://github.com/eueung) % linkprop https://eueung.github.io/112016/firebase % otherprop CodeLabs | [Attribution-ShareAlike CC BY-SA](https://creativecommons.org/licenses/by-sa/4.0/) % bkgimg bkgs/rambutan.jpg % logopic images/firebase.png
